    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="panel-body">
                <form action="/admin/editBlog/{{$product->id}}" method="POST" class="form-horizontal " style="display: flex;
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseSEO" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                          <form action="/admin/EditSEOBlog1/{{$product->id}}" method="POST" class="form-horizontal " style="display: flex;
                          flex-direction: column;" enctype="multipart/form-data">
                          @csrf
                            <div class="form-group">
