    ...
    <div class="container">
        <div class="wrapper">
            ...
            <div class="panel-body">
                <form action="/admin/editSubService/{{$product->id}}" method="POST" class="form-horizontal " style="display: flex;
                flex-direction: column;" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" style="height: 200px" name="description" type="text">{{$product->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
