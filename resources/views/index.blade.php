...
<head>
    ...
    <title>{{ $indexPage->indextitle }}</title>

    <meta name="title" content="{{ $indexPage->metatitleindex }}">
    <meta name="description" content="{{ $indexPage->metadescriptionindex }}">
    <meta name="keywords" content="{{ $indexPage->metakeyindex }}">
...
<body class="home-page">
    ...
    <main class="main">
        @include('components/page-main/hero')
        @include('components/page-main/mission')
        @include('components/proposal-banner')
        @include('components/page-main/advantages')
        @include('components/page-main/principles')
        @include('components/page-main/purpose-banner')
        @include('components/page-main/services')
        @include('components/page-main/reviews')
        @include('components/page-main/instagram')
        @include('components/page-main/contacts')
    </main>
