...
<head>
    ...
    <meta name="title" content="{{$indexPage->metatitlepractick}}">
    <meta name="description" content="{{$indexPage->metadescriptionpractick}}">
    <meta name="keywords" content="{{$indexPage->metakeypractick}}">
...
<body>
    ...
    <main class="main">
        ...
        "title"=> $indexPage->practitle,
        "breadcrumbs"=> $indexPage->practitle,
        "background" => "images/practics-bg.jpg"
        ])
        @include('components/page-practics/practics')
