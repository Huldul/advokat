    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="panel-body">
          <form action="/admin/addPractick" method="POST" class="form-horizontal " style="display: flex;
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control" id="focusedInput" name="author" type="text" value="{{ old('author') }}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" style="height: 200px" name="main"
                  type="text">{{ old('main') }}</textarea>
              </div>
            </div>
            </div>
            <div class="form-group">
